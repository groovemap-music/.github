...
This repository deliberately enables none of those shared files. In particular, it does
...
5. test inheritance in a disposable private repository before enabling it organization-wide.
